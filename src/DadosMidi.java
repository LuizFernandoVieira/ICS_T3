...
public class DadosMidi {
	...
	public void exibirDados(Sequence sequencia, Gui gui) {
	    ...
	    gui.dadosMidi.append("Duracao: " + duracao + " segundos" + System.lineSeparator());
	    ...
	    gui.dadosMidi.append("duracao do tique: " + (float)durtique*1000000 + " microssegundos" + System.lineSeparator());
